...
define( 'CEAD_ACAD_VERSION',    '0.87.0' );
...
require_once CEAD_ACAD_DIR . 'includes/class-cead-acad-hardening.php';
...
require_once CEAD_ACAD_DIR . 'modules/whatsapp/class-wa-images.php';
...
require_once CEAD_ACAD_DIR . 'includes/class-cead-acad-qr.php';
