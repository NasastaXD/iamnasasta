...
> Plugin **v0.32.0** · DB schema **v16** · Requiere WordPress 6.4+ y PHP 8.1+.
...
Se crean/actualizan idempotentemente con `dbDelta()` cuando sube `CEAD_ACAD_DB_VERSION` (actual: **16**).
