<?php
/**
 * /panel/calendario: agenda de eventos agrupada por día.
 */
	...
	<section class="cead-acad-panel-section">
		<div style="display:flex;justify-content:space-between;align-items:flex-end;gap:1rem;flex-wrap:wrap">
			<div>
				...
				<h2 class="cead-acad-panel-h"><?php esc_html_e( 'Calendario de eventos', 'cead-acad' ); ?></h2>
				<p class="cead-acad-panel-sub"><?php esc_html_e( 'Eventos, reuniones y exámenes dirigidos a vos.', 'cead-acad' ); ?></p>
			</div>
