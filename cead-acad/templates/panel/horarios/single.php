<?php
/**
 * /panel/horarios/{id}: detalle de evento.
 */
...
if ( ! $can_view ) {
	...
	$body = function () {
		...
		<section class="cead-acad-panel-section">
			...
			<p><a class="cead-acad-btn cead-acad-btn--ghost" href="<?php echo esc_url( cead_acad_url( 'panel/horarios' ) ); ?>">← <?php esc_html_e( 'Volver a la agenda', 'cead-acad' ); ?></a></p>
		</section>
		<?php
	};
...
$body = function () use ( $post, $start, $end, $all, $loc, $type ) {
	...
	<article class="cead-acad-panel-section cead-acad-bcast">
		<p class="cead-acad-bcast-back">
			<a href="<?php echo esc_url( cead_acad_url( 'panel/horarios' ) ); ?>">← <?php esc_html_e( 'Agenda', 'cead-acad' ); ?></a>
		</p>
